...
<div class="tab-content">
	<div class="tab-pane fade in active" id="planes">
		<div style="padding-bottom: 5px;">
			...
			<?php query_posts(array('category_name' => 'convenio empresa', 'tag' => 'arica'));
			while ( have_posts() ) : the_post(); ?>
		...
		<div style="padding-top:5px; padding-bottom: 20px;">
			<?php query_posts(array('category_name' => 'plan semestral', 'tag' => 'arica'));
			while ( have_posts() ) : the_post(); ?>
			<img src="<?php $src = wp_get_attachment_image_src(get_post_thumbnail_id($post -> ID), array(720, 405), false, '');
				echo $src[0];
			?>" class="img-polaroid">
			...
			<?php query_posts(array('category_name' => 'plan trimestral', 'tag' => 'arica'));
			while ( have_posts() ) : the_post(); ?>
		...
		<div>
			<?php query_posts(array('category_name' => 'promocion activa', 'tag' => 'arica'));
			while ( have_posts() ) : the_post(); ?>
			<img src="<?php $src = wp_get_attachment_image_src(get_post_thumbnail_id($post -> ID), array(720, 405), false, '');
				echo $src[0];
			?>" class="img-polaroid">
	...
	<div class="tab-pane fade" id="convenio_empresa">
		<?php query_posts(array('category_name' => 'convenio empresa', 'tag' => 'arica'));/*&posts_per_page=3' );*/
		while ( have_posts() ) : the_post(); ?>
		<div class="row-fluid">
			<div class="span10">
				<p >
